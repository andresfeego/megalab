...
public class lbBacteriologoXapellido extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Bacteriologo bacteriologo;
	private  lbBacteriologoXapellido esta=null;
	 ...
	 * 
	 */
	public lbBacteriologoXapellido(ClrCuadroDeTexto cuadroTexto,OpBacteriologo op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaBacteriologoXapellido(cuadrodetexto.getText());
