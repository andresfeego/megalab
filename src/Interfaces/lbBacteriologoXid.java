...
public class lbBacteriologoXid extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Bacteriologo bacteriologo;
	private  lbBacteriologoXid esta=null;
	 ...
	 * 
	 */
	public lbBacteriologoXid(ClrCuadroDeTexto cuadroTexto,OpBacteriologo op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaBacteriologoXid(cuadrodetexto.getText());
