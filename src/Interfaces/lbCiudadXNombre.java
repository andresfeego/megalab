...
public class lbCiudadXNombre extends JDialog {
	 ...
	 * 
	 */
	public lbCiudadXNombre(ClrCuadroDeTexto cuadroTexto,OpCiudades op,Principal pri) {
	...
	public void listaok(){
		...
		try {		
			String[] ciudad=conexionBusqueda.getInstance().ciudadXid(tokens[0]);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaCiudadXnombre(cuadrodetexto.getText());
