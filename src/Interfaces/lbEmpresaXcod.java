...
public class lbEmpresaXcod extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Empresa empresa;
	private  lbEmpresaXcod esta=null;
	 ...
	 * 
	 */
	public lbEmpresaXcod(ClrCuadroDeTexto cuadroTexto,OpEmpresa op,Principal pri) {
	...
	public lbEmpresaXcod(ClrCuadroDeTexto cuadroTexto,OpRecepcion op,clrPanelBordes panel,Principal pri) {
...
public lbEmpresaXcod(ClrCuadroDeTexto cuadroTexto,OpAbonoXEmpresa op,clrPanelBordes panel,Principal pri) {
...
public lbEmpresaXcod(ClrCuadroDeTexto cuadroTexto,OpCuentaXEmpresa op,clrPanelBordes panel,Principal pri) {
...
try {
	Empresa empresa=conexionBusqueda.getInstance().empresaXid(idAsignar);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaEmpresaXcod(cuadrodetexto.getText());
