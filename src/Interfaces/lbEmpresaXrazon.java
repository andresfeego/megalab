...
public class lbEmpresaXrazon extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Empresa empresa;
	private  lbEmpresaXrazon esta=null;
	 ...
	 * 
	 */
	public lbEmpresaXrazon(ClrCuadroDeTexto cuadroTexto,OpEmpresa op,Principal pri) {
...
public lbEmpresaXrazon(ClrCuadroDeTexto cuadroTexto,OpRecepcion op,clrPanelBordes panel,Principal pri) {
...
public lbEmpresaXrazon(ClrCuadroDeTexto cuadroTexto,OpAbonoXEmpresa op,clrPanelBordes panel,Principal pri) {
...
public lbEmpresaXrazon(ClrCuadroDeTexto cuadroTexto,OpCuentaXEmpresa op,clrPanelBordes panel,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaEmpresaXrazon(cuadrodetexto.getText());
