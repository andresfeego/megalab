...
public class lbEspecialidadXSigla extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private  lbEspecialidadXSigla esta=null;
	 ...
	 * 
	 */
	public lbEspecialidadXSigla(ClrCuadroDeTexto cuadroTexto,OpEspecialidades op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaEspecialidadXsigla(cuadrodetexto.getText());
