...
public class lbEspecialidadXnombre extends JDialog {
	 ...
	 * 
	 */
	public lbEspecialidadXnombre(ClrCuadroDeTexto cuadroTexto,OpEspecialidades op,Principal pri) {
	...
	public void listaok(){
		...
		public void asignar(){
			...
			try {
				String[] sala=conexionBusqueda.getInstance().EspecialidadXsigla(tokens[0]);
				op.llenar(Integer.parseInt(sala[0]), sala[2], sala[1]);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaEspecialidadXnombre(cuadrodetexto.getText());
