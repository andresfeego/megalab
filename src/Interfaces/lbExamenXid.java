...
public class lbExamenXid extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Examen examen;
	private  lbExamenXid esta=null;
	 ...
	 * 
	 */
	public lbExamenXid(ClrCuadroDeTexto cuadroTexto,OpExamen op,Principal pri) {
...
public lbExamenXid(ClrCuadroDeTexto cuadroTexto,OpPerfiles op,clrPanelBordes panel,Principal pri) {
...
public lbExamenXid(ClrCuadroDeTexto cuadroTexto,OpItemCotizacion op,clrPanelBordes panel,Principal pri) {
	...
	public lbExamenXid(ClrCuadroDeTexto cuadroTexto,OpItemRecepcion op,clrPanelBordes panel,Principal pri) {
	...
	public lbExamenXid(ClrCuadroDeTexto cuadroTexto,OpResXSeccion op,clrPanelBordes panel,Principal pri) {
	...
	public void listaok(){
		...
		examen=conexionBusqueda.getInstance().examenXcodigo(tokens[0]);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaExamenXid(cuadrodetexto.getText());
