...
public class lbGrupoEXnombre extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private GruposEmpresas grupoEmpresa;
	private  lbGrupoEXnombre esta=null;
	private  CerrarBusquedaInactiva crono=null;
	private  ClrCuadroDeTexto cuadrodetexto;
	private  JList list;
	private OpGrupoEmpresa op;
				private  int s=-1;
	 ...
	 * 
	 */
	public lbGrupoEXnombre(ClrCuadroDeTexto cuadroTexto,OpGrupoEmpresa op,Principal pri) {
	...
	public void listaok(){
		...
		GruposEmpresas grupoEmpresa=conexionBusqueda.getInstance().grupoEmpresaXnombre(list.getSelectedValue().toString());
				esta.setMedico(grupoEmpresa);
				op.llenar(grupoEmpresa);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaGrupoEmpresaXnombre(cuadrodetexto.getText());
		...
		public GruposEmpresas getGrupoEmpresa() {
			return grupoEmpresa;
		}

		public void setMedico(GruposEmpresas grupoEmpresa) {
