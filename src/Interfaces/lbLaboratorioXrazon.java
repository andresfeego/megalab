...
public class lbLaboratorioXrazon extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private  lbLaboratorioXrazon esta=null;
	 ...
	 * 
	 */
	public lbLaboratorioXrazon(ClrCuadroDeTexto cuadroTexto,OpLaboratorios op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaLaboratorioXnombre(cuadrodetexto.getText());
