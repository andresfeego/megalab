...
public class lbMedicoXid extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Medico medico;
	private  lbMedicoXid esta=null;
	 ...
	 * 
	 */
	public lbMedicoXid(ClrCuadroDeTexto cuadroTexto,OpMedico op,Principal pri) {
...
public lbMedicoXid(ClrCuadroDeTexto cuadroTexto,OpRecepcion op,clrPanelBordes panel,Principal pri) {
...
public lbMedicoXid(ClrCuadroDeTexto cuadroTexto,OpCambiosRecepcion op,clrPanelBordes panel,Principal pri) {
...
public lbMedicoXid(ClrCuadroDeTexto cuadroTexto,OpAnularRecepcion op,clrPanelBordes panel,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaMedicoXid(cuadrodetexto.getText());
