...
public class lbMedicoXnombre extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Medico medico;
	private  lbMedicoXnombre esta=null;
	 ...
	 * 
	 */
	public lbMedicoXnombre(ClrCuadroDeTexto cuadroTexto,OpMedico op,Principal pri) {
...
public lbMedicoXnombre(ClrCuadroDeTexto cuadroTexto,OpRecepcion op,clrPanelBordes panel,Principal pri) {
...
public lbMedicoXnombre(ClrCuadroDeTexto cuadroTexto,OpCambiosRecepcion op,clrPanelBordes panel,Principal pri) {
...
public lbMedicoXnombre(ClrCuadroDeTexto cuadroTexto,OpAnularRecepcion op,clrPanelBordes panel,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaMedicoXnombre(cuadrodetexto.getText());
