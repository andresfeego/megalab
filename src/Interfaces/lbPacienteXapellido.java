...
public class lbPacienteXapellido extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Paciente paciente;
	private  lbPacienteXapellido esta=null;
	 ...
	 * 
	 */
	public lbPacienteXapellido(ClrCuadroDeTexto cuadroTexto,OpPaciente op,Principal pri) {
...
public lbPacienteXapellido(ClrCuadroDeTexto cuadroTexto,OpRecepcion op,clrPanelBordes panel,Principal pri) {
...
public lbPacienteXapellido(ClrCuadroDeTexto cuadroTexto,OpAbonoXpaciente op,clrPanelBordes panel,Principal pri) {
...
public lbPacienteXapellido(ClrCuadroDeTexto cuadroTexto,OpCuentaXPaciente op,clrPanelBordes panel,Principal pri) {
	...
	public void listaok(){
		...
		String[] tokens = list.getSelectedValue().toString().split(" • ");
			...
			try {
				pacien=conexionBusqueda.getInstance().pacienteXid(tokens[0]);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaPacienteXapellido(cuadrodetexto.getText());
