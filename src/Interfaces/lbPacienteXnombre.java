...
public class lbPacienteXnombre extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Paciente paciente;
	private  lbPacienteXnombre esta=null;
	 ...
	 * 
	 */
	public lbPacienteXnombre(ClrCuadroDeTexto cuadroTexto,OpPaciente op,Principal pri) {
...
public lbPacienteXnombre(ClrCuadroDeTexto cuadroTexto,OpRecepcion op1,clrPanelBordes panel,Principal pri) {
...
public lbPacienteXnombre(ClrCuadroDeTexto cuadroTexto,OpAbonoXpaciente op,clrPanelBordes panel,Principal pri) {
...
public lbPacienteXnombre(ClrCuadroDeTexto cuadroTexto,OpCuentaXPaciente op,clrPanelBordes panel,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaPacienteXnombre(cuadrodetexto.getText());
