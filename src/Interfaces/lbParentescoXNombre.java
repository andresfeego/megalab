...
public class lbParentescoXNombre extends JDialog {
	 ...
	 * 
	 */
	public lbParentescoXNombre(ClrCuadroDeTexto cuadroTexto,OpParentesco op,Principal pri) {
	...
	public void listaok(){
		...
		String[] ciudad=conexionBusqueda.getInstance().parentesoXid(tokens[0]);
		
				op.llenar(Integer.parseInt(ciudad[0]),ciudad[1]);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaParentescoXnombre(cuadrodetexto.getText());
