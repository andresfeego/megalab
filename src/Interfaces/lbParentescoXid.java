...
public class lbParentescoXid extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private  lbParentescoXid esta=null;
	 ...
	 * 
	 */
	public lbParentescoXid(ClrCuadroDeTexto cuadroTexto,OpParentesco op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaParentescoXid(cuadrodetexto.getText());
