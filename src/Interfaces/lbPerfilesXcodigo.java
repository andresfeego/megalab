...
public class lbPerfilesXcodigo extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private PerfilExamenes PerfilExamen;
	private  lbPerfilesXcodigo esta=null;
	...
	public lbPerfilesXcodigo(ClrCuadroDeTexto cuadroTexto,OpItemRecepcion op,clrPanelBordes panel, clrPanelBordes panelinterno,Principal pri) {
...
public lbPerfilesXcodigo(ClrCuadroDeTexto cuadroTexto,OpPerfiles op,Principal pri) {
...
public lbPerfilesXcodigo(ClrCuadroDeTexto cuadroTexto,OpItemCotizacion op,clrPanelBordes panel, clrPanelBordes panelinterno,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaPerfilesXcodigo(cuadrodetexto.getText());
