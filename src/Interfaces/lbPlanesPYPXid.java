...
public class lbPlanesPYPXid extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private  lbPlanesPYPXid esta=null;
	 ...
	 * 
	 */
	public lbPlanesPYPXid(ClrCuadroDeTexto cuadroTexto,OpPyP op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaPlanesPYPXid(cuadrodetexto.getText());
