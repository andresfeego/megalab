...
public class lbPlanesPYPXnombre extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private  lbPlanesPYPXnombre esta=null;
	 ...
	 * 
	 */
	public lbPlanesPYPXnombre(ClrCuadroDeTexto cuadroTexto,OpPyP op,Principal pri) {
	...
	public void listaok(){
		...
		String[] ciudad=conexionBusqueda.getInstance().planPYPXid(tokens[0]);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaPlanesPYPXnombre(cuadrodetexto.getText());
