...
public class lbSalaXSigla extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private  lbSalaXSigla esta=null;
	 ...
	 * 
	 */
	public lbSalaXSigla(ClrCuadroDeTexto cuadroTexto,OpSalas op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaSalaXsigla(cuadrodetexto.getText());
