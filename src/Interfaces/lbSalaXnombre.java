...
public class lbSalaXnombre extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private  lbSalaXnombre esta=null;
	 ...
	 * 
	 */
	public lbSalaXnombre(ClrCuadroDeTexto cuadroTexto,OpSalas op,Principal pri) {
	...
	public void listaok(){
		...
		String[] sala=conexionBusqueda.getInstance().SalaXsigla(tokens[0]);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaSalaXNombre(cuadrodetexto.getText());
