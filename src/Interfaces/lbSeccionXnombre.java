...
public class lbSeccionXnombre extends JDialog {
	 ...
	 * 
	 */
	public lbSeccionXnombre(ClrCuadroDeTexto cuadroTexto,OpSecciones op,Principal pri) {
	...
	public void listaok(){
		...
		Secciones seccion=conexionBusqueda.getInstance().seccionXnombre(tokens[0]);
				esta.setSeccion(seccion);
				op.llenar(seccion);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaSeccionXnombre(cuadrodetexto.getText());
