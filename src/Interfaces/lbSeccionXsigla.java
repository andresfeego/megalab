...
public class lbSeccionXsigla extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Secciones seccion;
	private  lbSeccionXsigla esta=null;
	 ...
	 * 
	 */
	public lbSeccionXsigla(ClrCuadroDeTexto cuadroTexto,OpSecciones op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaSeccionXid(cuadrodetexto.getText());
