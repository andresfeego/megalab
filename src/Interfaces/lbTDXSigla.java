...
public class lbTDXSigla extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private TipoDato TD;
	private  lbTDXSigla esta=null;
	 ...
	 * 
	 */
	public lbTDXSigla(ClrCuadroDeTexto cuadroTexto,OpTipoDato op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaTDXSigla(cuadrodetexto.getText());
