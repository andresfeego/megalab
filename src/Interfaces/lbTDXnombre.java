...
public class lbTDXnombre extends JDialog {
	 ...
	 * 
	 */
	public lbTDXnombre(ClrCuadroDeTexto cuadroTexto,OpTipoDato op,Principal pri) {
	...
	public void listaok(){
		...
		TipoDato TD=conexionBusqueda.getInstance().TDXnombre(tokens[0]);
				esta.setMedico(TD);
				op.llenar(TD);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaTDXnombre(cuadrodetexto.getText());
		...
		public TipoDato getGrupoEmpresa() {
			return TD;
		}

		public void setMedico(TipoDato grupoEmpresa) {
			this.TD = grupoEmpresa;
		}
