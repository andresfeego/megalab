...
public class lbTMXNombre extends JDialog {
	 ...
	 * 
	 */
	public lbTMXNombre(ClrCuadroDeTexto cuadroTexto,OpTipoMuestras op,Principal pri) {
	...
	public void listaok(){
		...
		TipoMuestra TM=conexionBusqueda.getInstance().muestraXsigla(tokens[0]);
				esta.setTipoMuestra(TM);
				op.llenar(TM);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaTipomuestraXnombre(cuadrodetexto.getText());
		...
		public void setTipoMuestra(TipoMuestra muestra) {
			this.TM = muestra;
		}
