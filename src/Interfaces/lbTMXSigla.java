...
public class lbTMXSigla extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private TipoMuestra TM;
	private  lbTMXSigla esta=null;
	 ...
	 * 
	 */
	public lbTMXSigla(ClrCuadroDeTexto cuadroTexto,OpTipoMuestras op,Principal pri) {
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaTipomuestraXsigla(cuadrodetexto.getText());
