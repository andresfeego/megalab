...
public class lbTarifaXnombre extends JDialog {
	 ...
	 * 
	 */
	public lbTarifaXnombre(ClrCuadroDeTexto cuadroTexto,OpTarifas op,Principal pri) {
	...
	public void listaok(){
		...
		String[] tarifa=conexionBusqueda.getInstance().tarifaXnombre(tokens[0]);
		
				op.llenar(Integer.parseInt(tarifa[0]), tarifa[1], tarifa[2]);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaTarifaXnombre(cuadrodetexto.getText());
