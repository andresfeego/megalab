...
public class lbUsuarioWebXid extends JDialog {
	 ...
	 */
				...
				public lbUsuarioWebXid(ClrCuadroDeTexto cuadroTexto,OpUsuarioWEB oc,Principal pri) {
	...
	public void listaok(){
		...
		public void asignarUsuario(){
			...
			String[] usuario=conexionBusqueda.getInstance().usuariowebXid(list.getSelectedValue().toString());
			if(oc!=null){oc.llenar(usuario[0],Integer.parseInt(usuario[1]));};
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaUsuarioWebXid(cuadrodetexto.getText());
