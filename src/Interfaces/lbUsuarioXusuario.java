...
public class lbUsuarioXusuario extends JDialog {

	private clrPanelBordes contentPane;
	private Principal principal;
	private Usuario usuario;
	private  lbUsuarioXusuario esta=null;
	 ...
	 * 
	 */
				public lbUsuarioXusuario(ClrCuadroDeTexto cuadroTexto,OpUsuario ou,Principal pri) {
				...
				public lbUsuarioXusuario(ClrCuadroDeTexto cuadroTexto,OpControlAcceso oc,Principal pri) {
	...
	public void listaok(){
		...
		public void asignarUsuario(){
			...
			Usuario usuario=conexionBusqueda.getInstance().usuarioXusuario(list.getSelectedValue().toString());
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaUsuarioXusuario(cuadrodetexto.getText());
