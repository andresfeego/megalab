...
public lbfacturaXID(ClrCuadroDeTexto cuadroTexto,OpAbonoXFactura op,clrPanelBordes panel,Principal pri) {
...
public lbfacturaXID(ClrCuadroDeTexto cuadroTexto,OpNotasCD op,clrPanelBordes panel,Principal pri) {
	...
	public void listaok(){
				...
				cuadrodetexto.addKeyListener(new KeyAdapter() {
							...
							public void keyPressed(KeyEvent e) {
								...
								if (e.getKeyCode()==KeyEvent.VK_ENTER) {
									...
									lbfacturaXID.this.setVisible(false);
								} 
							}
		...
		Factura factura=conexionBusqueda.getInstance().FacturaXID(tokens[0]);
				
		if (op1!=null)op1.llenarFactura(factura);
		if (op2!=null)op2.llenarFactura(factura);
		...
		if (busqueda.equals("")) {
			list.setModel(new AbstractListModel() {
				...
				list.setModel(new AbstractListModel() {
					...
					String[] values=conb.busquedaFacturasXID(cuadrodetexto.getText());
